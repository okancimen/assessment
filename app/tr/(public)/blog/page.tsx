...
export const metadata: Metadata = {
  ...
  keywords: [
    'staj rehberi',
    'lise iş deneyimi',
    'üniversiteden önce staj',
    'teknoloji stajı öğrenci',
    'kariyer gelişimi gençler',
    'üniversite kabulü iş deneyimi',
    'kariyer rehberi',
  ],
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-[#6e6e73] leading-relaxed max-w-2xl">
            Erken iş deneyimi, kariyer gelişimi ve üniversiteye erişim üzerine kanıta dayalı rehberler — lise öğrencileri için.
          </p>
        </div>

        <div className="space-y-6">
          {[...BLOG_POSTS_TR].sort((a, b) => b.date.localeCompare(a.date)).map((post) => (
            <Link
              key={post.slug}
