...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: { tr: `${BASE_URL}/tr/hakkimizda`, es: `${BASE_URL}/es/sobre-nosotros`, 'en-GB': `${BASE_URL}/about`, fr: `${BASE_URL}/fr/a-propos`, 'x-default': `${BASE_URL}/about` },
  },
...
const BREADCRUMB_SCHEMA = {
  ...
  '@type': 'BreadcrumbList',
  itemListElement: [
    { '@type': 'ListItem', position: 1, name: 'Ana Sayfa', item: 'https://eduentry.com/tr' },
    { '@type': 'ListItem', position: 2, name: 'Hakkımızda', item: 'https://eduentry.com/tr/hakkimizda' },
  ],
}
