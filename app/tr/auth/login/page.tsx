...
export default function TRLoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f5f5f7] px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <Logo size="lg" className="justify-center" href="/tr" />
          <h1 className="text-2xl font-bold text-[#1d1d1f] mt-7 mb-1 tracking-tight">Tekrar hoş geldiniz</h1>
          <p className="text-sm text-[#6e6e73]">Ebeveyn hesabınıza giriş yapın</p>
        </div>
        ...
        <p className="text-center text-xs text-[#6e6e73] mt-6">
          Hesabınız yok mu?{' '}
          <Link href="/tr/auth/register" className="text-[#4F46E5] font-semibold hover:underline">
            Oluşturun
          </Link>
        </p>
      </div>
