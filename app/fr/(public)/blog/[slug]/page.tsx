...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: `${BASE_URL}/fr/blog/${slug}/opengraph-image`, width: 1200, height: 630, alt: post.title }],
    },
    twitter: {
      card: 'summary_large_image',
      title: post.title,
      description: post.description,
      images: [`${BASE_URL}/fr/blog/${slug}/opengraph-image`],
    },
  }
}
  ...
  return (
    <main lang="fr" className="max-w-3xl mx-auto px-6 py-16">
      ...
      <nav className="text-sm text-[#6e6e73] mb-8">
        ...
        <Link href="/fr/blog" className="hover:text-[#1d1d1f]">Blog</Link>
        <span className="mx-2">›</span>
      ...
      {related.length > 0 && (
        <section className="mt-16 mb-12">
          <h2 className="text-xl font-bold text-[#1d1d1f] mb-6">Articles connexes</h2>
