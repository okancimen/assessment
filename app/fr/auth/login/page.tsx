    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f5f5f7] px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#1d1d1f] mt-7 mb-1 tracking-tight">Connectez-vous à Eduentry</h1>
          <p className="text-sm text-[#6e6e73]">Accédez aux résultats de votre enfant</p>
        </div>
        ...
        <p className="text-center text-xs text-[#6e6e73] mt-6">
          ...
          <Link href="/fr/auth/register" className="text-[#4F46E5] font-semibold hover:underline">
            En créer un
          </Link>
        </p>
      </div>
