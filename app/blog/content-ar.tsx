  ...
  'ma-huwa-pisa-natayij-2025-al-hayat-al-mihniyya': (
    <>
      ...
      <section>
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          تقييم Eduentry الأكاديمي مبني تحديداً على هذه المنهجية. يُقيّم الأطفال من 6 إلى 17 سنة في الرياضيات والقراءة والتفكير المنطقي اللفظي وغير اللفظي، ويُنتج درجة معيارية محاذاة للمقياس الدولي لـ PISA. التقييم يستغرق 20-30 دقيقة ولا يتطلب تسجيلاً مسبقاً.
        </p>
        <Callout color="emerald">
      ...
      <section>
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          PISA لا يحدد مصير أي طالب. لكنه يقيس متانة الأساس الذي يبني عليه مستقبله. حين تعرف أين يقف طفلك على هذا المقياس، يمكنك التصرف بدقة — لا بقلق. والخطوة الأولى ليست مكلفة ولا معقدة: تقييم 20 دقيقة يضعك أمام صورة واضحة لموقعه العالمي.
        </p>
      </section>
    </>
  ),
