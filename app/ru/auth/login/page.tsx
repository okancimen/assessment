...
function LoginForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <label className="block text-xs font-semibold text-[#1d1d1f] mb-2 uppercase tracking-wide">Адрес электронной почты</label>
        <input
          type="email"
          value={email}
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f5f5f7] px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#1d1d1f] mt-7 mb-1 tracking-tight">Войти в аккаунт</h1>
          <p className="text-sm text-[#6e6e73]">Войдите в родительский аккаунт</p>
        </div>
        ...
        <p className="text-center text-xs text-[#6e6e73] mt-6">
          Нет аккаунта?{' '}
          <Link href="/ru/auth/register" className="text-[#4F46E5] font-semibold hover:underline">
            Зарегистрируйтесь
          </Link>
        </p>
      </div>
