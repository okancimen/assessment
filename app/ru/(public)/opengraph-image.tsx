...
export const alt = 'Eduentry — Платформа академической оценки и готовности к стажировке'
    ...
    (
      <div style={{ background: '#1d1d1f', width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: 'system-ui, sans-serif', padding: '60px' }}>
        ...
        <div style={{ fontSize: 22, color: '#86868b', fontWeight: 700, marginBottom: 24, letterSpacing: '0.1em', textTransform: 'uppercase' }}>
          Ocenka dlya kazhdogo etapa obucheniya
        </div>
        ...
        <div style={{ display: 'flex', gap: 20 }}>
          <div style={{ background: '#2d2d2f', border: '1px solid #424245', borderRadius: 20, padding: '18px 32px', display: 'flex', flexDirection: 'column', gap: 8, minWidth: 280 }}>
            <div style={{ fontSize: 11, color: '#86868b', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', display: 'flex' }}>Akademicheskaya ocenka</div>
            <div style={{ fontSize: 18, color: '#f5f5f7', fontWeight: 600, display: 'flex' }}>6-17 let · Mezhdunarodnyy orientir</div>
          </div>
          <div style={{ background: '#eef2ff', border: '1px solid #c7d2fe', borderRadius: 20, padding: '18px 32px', display: 'flex', flexDirection: 'column', gap: 8, minWidth: 280 }}>
            <div style={{ fontSize: 11, color: '#4f46e5', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', display: 'flex' }}>Ocenka stazhirovki</div>
            <div style={{ fontSize: 18, color: '#1d1d1f', fontWeight: 600, display: 'flex' }}>14+ let · Gotovnost k rabote</div>
          </div>
        </div>

        <div style={{ position: 'absolute', bottom: 32, fontSize: 20, color: '#6e6e73' }}>eduentry.com/ru</div>
      </div>
    ),
    { ...size }
  )
