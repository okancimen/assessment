...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://eduentry.com/methodology', languages: { 'en-GB': 'https://eduentry.com/methodology', es: 'https://eduentry.com/es/metodologia', 'x-default': 'https://eduentry.com/methodology' } },
