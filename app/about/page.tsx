...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://eduentry.com/about', languages: { 'en-GB': 'https://eduentry.com/about', es: 'https://eduentry.com/es/sobre-nosotros', tr: 'https://eduentry.com/tr/hakkimizda', fr: 'https://eduentry.com/fr/a-propos', ar: 'https://eduentry.com/ar/hawlana', ru: 'https://eduentry.com/ru/o-nas', zh: 'https://eduentry.com/zh/guanyu-women', 'x-default': 'https://eduentry.com/about' } },
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'About', item: 'https://eduentry.com/about' },
  ],
}
