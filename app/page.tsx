...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://eduentry.com', languages: { 'en-GB': 'https://eduentry.com', es: 'https://eduentry.com/es', tr: 'https://eduentry.com/tr', 'x-default': 'https://eduentry.com' } },
...
const FAQ_SCHEMA = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'Is Eduentry free to use?', acceptedAnswer: { '@type': 'Answer', text: "Yes, completely free. No subscriptions, hidden fees, or premium tiers. Create a free account, add your child's profile, and start the assessment at no cost." } },
    { '@type': 'Question', name: 'What subjects does the academic assessment cover?', acceptedAnswer: { '@type': 'Answer', text: "English (reading comprehension, grammar, vocabulary), Mathematics (arithmetic, algebra, geometry, problem-solving), Verbal Reasoning (analogies, classifications, sequences), and Non-Verbal Reasoning (patterns, spatial reasoning, matrices). Each subject has 15 adaptive questions." } },
    { '@type': 'Question', name: 'What is a percentile ranking?', acceptedAnswer: { '@type': 'Answer', text: "A percentile ranking shows how your child compares to all other children of the same age. A score in the 80th percentile means your child performed better than 80% of children at that age level. Eduentry uses a standardised scale with a mean of 100 and a standard deviation of 15 — the same scale used by PISA and most professional assessments." } },
