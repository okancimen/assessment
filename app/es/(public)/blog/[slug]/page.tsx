...
export default async function ESBlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const articleSchema = {
    ...
    url,
    inLanguage: 'es',
    image: `${BASE_URL}/es/blog/${slug}/opengraph-image`,
    ...
    <main lang="es" className="max-w-3xl mx-auto px-6 py-16">
      ...
      {post.tldr && (
        <div className="mb-10 border-l-4 border-indigo-400 bg-indigo-50 rounded-r-xl px-5 py-4">
          <p className="text-xs font-semibold text-indigo-500 uppercase tracking-wider mb-1">Respuesta rápida</p>
      ...
      <section className="mt-12 border border-[#d2d2d7] rounded-2xl p-6 bg-[#f5f5f7]/50">
        ...
        <div className="space-y-4">
          {[
            { href: 'https://eduentry.ai/', title: 'Evaluación de Preparación para Prácticas', desc: 'Test adaptativo gratuito de 34 preguntas para estudiantes de 14+. Informe personalizado e información de IA sobre tu carrera.' },
