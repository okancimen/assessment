...
export const metadata: Metadata = {
  title: 'Evaluación de prácticas para estudiantes de instituto — Gratuita | Eduentry',
  description:
    'Evaluación de prácticas gratuita para estudiantes de 14 a 18 años. 34 preguntas adaptativas en Tecnología, Empresa, Datos y Marketing. Informe personalizado al instante.',
  keywords: [
    'evaluación preparación prácticas Reino Unido',
    'prácticas gratis estudiantes instituto',
    'informe preparación prácticas',
  ...
  openGraph: {
    ...
    title: 'Evaluación de prácticas para estudiantes de instituto — Gratuita | Eduentry',
    description: 'Evaluación de preparación para prácticas gratuita para estudiantes de 14 a 18 años. 34 preguntas adaptativas en 4 áreas. Informe personalizado al instante.',
    images: [{ url: `${BASE_URL}/opengraph-image`, width: 1200, height: 630, alt: 'Eduentry — Evaluación de preparación para prácticas' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Evaluación de prácticas para estudiantes de instituto — Gratuita | Eduentry',
    description: 'Evaluación de prácticas gratuita para estudiantes de 14 a 18 años. 34 preguntas, informe personalizado al instante.',
...
const FAQS = [
  ...
  { q: '¿Para quién es?',                        a: 'Para estudiantes de instituto de 14 a 18 años que quieran adquirir experiencia profesional.' },
  ...
  { q: '¿Qué área debo elegir?',                 a: 'Al solicitar, puedes ordenar tus preferencias de área entre Tecnología, Empresa, Análisis de datos y Marketing digital. La fase de Perfil de intereses también ayuda a identificar dónde encajas mejor.' },
  { q: '¿Cuándo recibo mi informe de preparación?', a: 'Inmediatamente después de terminar. Una vez que completas las 34 preguntas, la puntuación se calcula al instante y el informe queda disponible en tu cuenta — sin esperas.' },
  { q: '¿Puedo usar la evaluación en mi CV?',    a: 'Sí. Tu informe de preparación incluye una puntuación medible y un desglose de habilidades por área que puedes mencionar directamente en tus solicitudes.' },
]
...
const SERVICE_SCHEMA = {
  ...
  '@type': 'Service',
  '@id': `${BASE_URL}/#service-es`,
  name: 'Evaluación de preparación para prácticas',
  url: PAGE_URL,
  description: 'Evaluación adaptativa gratuita de 34 preguntas para estudiantes de instituto de 14 a 18 años. Evalúa aptitud, conocimientos del sector, habilidades profesionales y perfil de intereses en cuatro áreas: Tecnología, Empresa, Análisis de datos y Marketing digital.',
  inLanguage: 'es',
      ...
      <section className="py-16 bg-white text-center px-6">
        <div className="max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-[#eef2ff] text-[#4F46E5] text-xs font-semibold px-3 py-1.5 rounded-full mb-8 tracking-[0.1em] uppercase">
            Gratuita · 35 minutos · Informe personalizado
          </div>
          ...
          <p className="text-xl text-[#6e6e73] max-w-xl mx-auto mb-10 leading-relaxed">
            Evaluación adaptativa de 34 preguntas diseñada para estudiantes de instituto mayores de 14 años. Descubre tu nivel de preparación en cuatro áreas profesionales y obtén un informe personalizado.
          </p>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
            {INTERNSHIP_TRACKS.map((track, i) => (
              <div
                key={track}
                className="bg-white rounded-3xl border border-[#d2d2d7] overflow-hidden"
              >
                ...
                <div className="p-5">
                  <h3 className="font-bold text-[#1d1d1f] text-base mb-1.5">{TRACK_LABELS_ES[track]}</h3>
                  <p className="text-xs text-[#6e6e73] leading-relaxed">{TRACK_DESCRIPTIONS_ES[track]}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="bg-white rounded-3xl border border-[#d2d2d7] overflow-hidden">
            ...
            <div className="border-t border-[#f5f5f7] bg-[#f5f5f7] px-7 py-4">
              <span className="text-xs text-[#6e6e73]">Total: 34 preguntas · ~35 minutos · Completamente reanudable</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white text-center px-6">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-lg text-[#6e6e73] mb-10">
            34 preguntas. 35 minutos. Informe personalizado y el primer paso hacia unas prácticas reales.
          </p>
          <Link
            href="/internship/apply"
