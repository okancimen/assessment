...
import { InternshipSubject, InternshipTrack, getInternshipSubjects, INTERNSHIP_QUESTIONS_PER_SUBJECT } from '@/types'
...
export async function POST(
  ...
  try {
    ...
    // For interest_profile: record track preference
    ...
    // For aptitude: maintain IRT response array
    ...
    // IRT-based difficulty update only for aptitude subjects
    ...
    // Determine if all subjects complete
    ...
    console.error('[internship/answer]', message)
