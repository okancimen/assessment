...
export const metadata: Metadata = {
  title: 'أدلة التدريب والمسار المهني — مدونة Eduentry',
  description:
    'أبحاث وتحليلات حول التدريب المهني والخبرة العملية في المرحلة الثانوية والوصول إلى الجامعة — من فريق Eduentry. أدلة في التكنولوجيا والأعمال والبيانات والتسويق.',
  keywords: [
    'دليل تدريب مهني طلاب الثانوية',
    'خبرة عملية مدرسة ثانوية',
    'تدريب قبل الجامعة',
    'تدريب تكنولوجيا طلاب',
    'تطوير مهني شباب',
    'قبول جامعي خبرة عملية',
    'توجيه مهني دليل',
    'تدريب مهني الإمارات دليل',
  ],
  alternates: {
  ...
  openGraph: {
    type: 'website',
    title: 'أدلة التدريب والمسار المهني — مدونة Eduentry',
    description: 'أبحاث وتحليلات حول التدريب المهني والخبرة العملية في المرحلة الثانوية والوصول إلى الجامعة.',
    url: `${BASE_URL}/ar/blog`,
    siteName: 'Eduentry.ai',
    locale: 'ar_AE',
    alternateLocale: ['en_GB', 'tr_TR', 'es_ES', 'fr_FR', 'ru_RU', 'zh_CN'],
    images: [{ url: `${BASE_URL}/opengraph-image`, width: 1200, height: 630, alt: 'Eduentry.ai Blog — أدلة التدريب والمسار المهني' }],
  },
  twitter: {
...
export default function ARBlogIndexPage() {
  ...
  const itemList = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: 'أدلة التدريب والمسار المهني — مدونة Eduentry',
    url: `${BASE_URL}/ar/blog`,
    inLanguage: 'ar',
    numberOfItems: BLOG_POSTS_AR.length,
    ...
    <main lang="ar" dir="rtl" className="flex-1">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <nav className="text-sm text-[#6e6e73] mb-8">
          <Link href="/ar" className="hover:text-[#1d1d1f]">الصفحة الرئيسية</Link>
        ...
        <div className="mb-12">
          <h1 className="text-4xl sm:text-5xl font-bold text-[#1d1d1f] mb-4 leading-tight tracking-tight">
            أدلة التدريب والمسار المهني
          </h1>
          <p className="text-xl text-[#6e6e73] leading-relaxed max-w-2xl">
            أدلة مستندة إلى الأدلة حول الخبرة المهنية المبكرة وتطوير المسار الوظيفي والوصول إلى الجامعة لطلاب المرحلة الثانوية.
          </p>
        </div>
