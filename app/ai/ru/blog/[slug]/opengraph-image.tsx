...
import { getRussianPostBySlug } from '@/app/blog/posts-ru'
...
export default async function Image({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const title = post?.shortTitle ?? 'Исследования в области стажировки и карьеры'
  const tag = post?.tags[0] ?? 'Стажировка'
